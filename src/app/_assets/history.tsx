    ...
    <div className="flex flex-wrap gap-5">
      <div className="flex w-full flex-col md:w-fit">
        ...
        <div className="flex flex-col gap-1 p-2 text-sm">
          <div className="text-base">2024. 06. 24 ~ 재직중</div>
          <div>공기업 한국남동발전 웹 페이지 유지/보수 및 개발</div>
          <div>전자정부 프레임워크 Spring MVC 패턴으로 CMS 개발</div>
          <div>Jsp, Controller, VO, XML에 Service를 더해 구조 개선</div>
          <div>Script, 웹 표준으로 까다로운 공기업 접근성 심사 통과</div>
        </div>
      </div>
      <div className="flex w-full flex-col md:w-fit">
        <div className="flex flex-wrap items-end gap-2 border-b-8 border-muted-foreground p-1">
        ...
        <div className="flex flex-col gap-1 p-2 text-sm">
          ...
          <div>방문자 활동 수집을 위한 GA 및 GTM 구축</div>
